...
WeRelay evolved from the CLI WeChat Bridge project. Version 2.0 completed the independent WeRelay naming migration across local package metadata, CLI commands, runtime data directory, environment variables, documentation, and the GitHub release workflow.
